...
public abstract class CuerpoCeleste implements Cloneable {
    private final StringProperty nombre;
    private final DoubleProperty x;
    private final DoubleProperty y;

    public CuerpoCeleste(String nombre, double x, double y) {
    ...
    public CuerpoCeleste(CuerpoCeleste origen) {
    ...
    public void copia(CuerpoCeleste origen) {
    ...
    public boolean equals(Object o) {
        ...
        CuerpoCeleste estrella = (CuerpoCeleste) o;
    ...
    public abstract CuerpoCeleste clone();
}
