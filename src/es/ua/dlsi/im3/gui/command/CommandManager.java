...
public class CommandManager {
	...
	/**
	 * @param command
	 * @throws Exception Before the exception is thrown, an ERROR event is fired to the state machine
	 */
	public void executeCommand(final ICommand command) throws Exception {
	    //try {
		log.log(Level.INFO, "Executing {0}", command.toString());
		associatedDocumentNeedsSave.set(true);
